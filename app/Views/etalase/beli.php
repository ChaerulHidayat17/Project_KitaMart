...
<div class="container">
    <div class="row">
            ...
            <div class="card shadow-sm border rounded-lg mb-3">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <i class="fas fa-map-marker-alt text-muted me-2"></i> <select class="form-control"
                            id="provinsi">
                    ...
                    <div class="form-group">
                        ...
                        <i class="fas fa-truck text-muted me-2"></i> <select class="form-control" id="service">
                            <option>Select Service</option>
                        </select>
                    </div>
                    <div class="d-flex justify-content-between align-items-center">
                        <p class="text-muted mb-0">Estimasi:</p>
                        <span id="estimasi" class="text-success fw-bold"></span>
                    </div>
        ...
        <script src="https://app.sandbox.midtrans.com/snap/snap.js"
            data-client-key="SB-Mid-client-UwkEQI5QU00Vt5NK"></script>
